...
interface ChatListClientProps {
  preloadedData: Preloaded<typeof api.chat.bundle.getConversationsBundle>;
}

export function ChatListClient({ preloadedData }: ChatListClientProps) {
  const router = useRouter();
  const { conversations } = useChatListData(preloadedData);
